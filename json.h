...
typedef void *(*Json_Alloc_Func)(void *data, size_t size);
typedef void (*Json_Free_Func)(void *data, void *ptr, size_t size);

typedef struct {
    Json_Alloc_Func alloc;
    Json_Free_Func free;
    void *data;
} Json_Ator;
